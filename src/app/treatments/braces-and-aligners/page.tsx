...
export default function BracesAndAligners() {
  return (
    <>
      <Header />
        ...
        <section className="relative w-full bg-surface-container-lowest overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-12 pt-8 pb-16 lg:pb-24">
            ...
            <nav aria-label="Breadcrumb" className="flex items-center gap-2 mb-8 font-label-sm text-label-sm text-on-surface-variant">
              ...
              <span className="material-symbols-outlined text-[14px] text-outline">chevron_right</span>
              <span className="text-primary font-semibold">Braces &amp; Aligners</span>
            </nav>
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
              ...
              <div className="lg:col-span-7 flex flex-col items-start">
                ...
                <h1 className="font-headline-lg text-headline-lg lg:font-display-xl lg:text-display-xl text-primary tracking-tight mb-6">
                  Single-Sitting Painless Braces &amp; Aligners
                </h1>
                <p className="font-body-lg text-body-lg text-on-surface-variant mb-8 max-w-2xl leading-relaxed">
                  Achieve a perfectly straight, healthy smile with our advanced clear aligner systems or low-profile ceramic brackets, personalized for your unique bite.
                </p>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 w-full mb-8">
                  <div className="p-3 rounded-xl bg-surface-container-low flex flex-col">
                    <span className="font-headline-sm text-headline-sm text-primary">12-18m</span>
                    <span className="font-label-sm text-label-sm text-on-surface-variant mt-0.5">Avg Duration</span>
                  </div>
                  <div className="p-3 rounded-xl bg-surface-container-low flex flex-col">
                    <span className="font-headline-sm text-headline-sm text-primary">0%</span>
                    <span className="font-label-sm text-label-sm text-on-surface-variant mt-0.5">Discomfort</span>
                  </div>
                  <div className="p-3 rounded-xl bg-surface-container-low flex flex-col">
                    <span className="font-headline-sm text-headline-sm text-primary">100%</span>
                    <span className="font-label-sm text-label-sm text-on-surface-variant mt-0.5">Custom Fit</span>
                  </div>
                  <div className="p-3 rounded-xl bg-surface-container-low flex flex-col">
                    <span className="font-headline-sm text-headline-sm text-primary">5k+</span>
                    <span className="font-label-sm text-label-sm text-on-surface-variant mt-0.5">Smiles Aligned</span>
                  </div>
                </div>
                {/* CTAs */}
                ...
                <div className="flex flex-wrap items-center gap-2 pt-8">
                  <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-surface-container-low font-label-sm text-label-sm text-on-surface">
                    <span className="material-symbols-outlined text-secondary text-[16px]">verified</span> 3D Intraoral Scanning
                  </span>
                  <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-surface-container-low font-label-sm text-label-sm text-on-surface">
                    <span className="material-symbols-outlined text-secondary text-[16px]">verified</span> Clear Aligner Tech
                  </span>
                  <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-surface-container-low font-label-sm text-label-sm text-on-surface">
                    <span className="material-symbols-outlined text-secondary text-[16px]">verified</span> Invisible Aesthetics
                  </span>
                </div>
              </div>
              ...
              <div className="lg:col-span-5 relative">
                <div className="relative rounded-2xl overflow-hidden bg-surface-container shadow-xl">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-primary/90 via-primary/30 to-transparent flex flex-col justify-end p-6 text-on-primary">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <div>
                        <span className="font-title-lg text-title-lg block">Digital Smile Simulation</span>
                        <span className="font-label-sm text-label-sm text-secondary-fixed">Predictable Outcomes</span>
                      </div>
                    </div>
                    <p className="font-body-sm text-body-sm text-surface-variant">
                      See your future smile before treatment even begins with our advanced 3D scanning technology.
                    </p>
                  </div>
                </div>
                ...
                <div className="hidden sm:flex absolute -bottom-6 -left-6 bg-surface-container-lowest p-4 rounded-xl shadow-lg items-center gap-3 z-10 max-w-xs">
                  ...
                  <div>
                    <p className="font-title-lg text-title-lg text-on-surface">Discreet &amp; Comfortable</p>
                    <p className="font-body-sm text-body-sm text-on-surface-variant">No metal wires or brackets</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
              ...
              <div className="lg:col-span-5 flex flex-col">
                ...
                <h2 className="font-headline-md text-headline-md lg:font-headline-lg lg:text-headline-lg text-primary tracking-tight mb-6">
                  Understanding Orthodontic Realignment
                </h2>
                <p className="font-body-md text-body-md text-on-surface-variant mb-4 leading-relaxed">
                  Orthodontic treatment goes beyond aesthetics; it corrects bite mechanics, improves oral hygiene, and prevents jaw strain.
                </p>
                <p className="font-body-md text-body-md text-on-surface-variant mb-6 leading-relaxed">
                  Using continuous, gentle pressure, braces or clear aligners slowly shift teeth into their optimal positions. This process remodels the surrounding jawbone, ensuring long-lasting stability.
                </p>
                <div className="p-6 rounded-xl bg-surface-container-high flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-title-lg text-title-lg text-primary mb-1">Health vs. Aesthetics</h4>
                    <p className="font-body-sm text-body-sm text-on-surface-variant">
                      Straight teeth are easier to clean, reducing the risk of decay and gum disease while giving you a confident, beautiful smile.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="lg:col-span-7">
                <div className="mb-4">
                  ...
                  <h3 className="font-headline-sm text-headline-sm text-primary mt-1">Signs You Might Need Orthodontics</h3>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="p-5 rounded-xl bg-surface-container-lowest shadow-sm hover:shadow-md transition-all flex flex-col justify-between">
                    ...
                    <div>
                      <h4 className="font-title-lg text-title-lg text-on-surface mb-1">Crowding</h4>
                      <p className="font-body-sm text-body-sm text-on-surface-variant">
                        Teeth overlapping or bunched together, making it difficult to brush and floss properly.
                      </p>
                    </div>
                  </div>
                  {/* Symptom 2 */}
                  <div className="p-5 rounded-xl bg-surface-container-lowest shadow-sm hover:shadow-md transition-all flex flex-col justify-between">
                    ...
                    <div>
                      <h4 className="font-title-lg text-title-lg text-on-surface mb-1">Spacing</h4>
                      <p className="font-body-sm text-body-sm text-on-surface-variant">
                        Visible gaps between teeth which can trap food and cause gum inflammation.
                      </p>
                    </div>
                  </div>
                  {/* Symptom 3 */}
                  <div className="p-5 rounded-xl bg-surface-container-lowest shadow-sm hover:shadow-md transition-all flex flex-col justify-between">
                    ...
                    <div>
                      <h4 className="font-title-lg text-title-lg text-on-surface mb-1">Overbite</h4>
                      <p className="font-body-sm text-body-sm text-on-surface-variant">
                  ...
                  <div className="p-5 rounded-xl bg-surface-container-lowest shadow-sm hover:shadow-md transition-all flex flex-col justify-between">
                    ...
                    <div>
                      <h4 className="font-title-lg text-title-lg text-on-surface mb-1">Underbite</h4>
                      <p className="font-body-sm text-body-sm text-on-surface-variant">
                  ...
                  <div className="md:col-span-2 p-5 rounded-xl bg-surface-container-low shadow-sm flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="font-title-lg text-title-lg text-on-surface mb-1">Crossbite</h4>
                      <p className="font-body-sm text-body-sm text-on-surface-variant">
                        Upper and lower jaws are misaligned when biting together.
                      </p>
                    </div>
                  </div>
                </div>
        ...
        <section className="w-full py-16 lg:py-24 bg-surface-container-lowest">
          <div className="max-w-7xl mx-auto px-6 lg:px-12">
            <div className="text-center max-w-3xl mx-auto mb-16">
              <span className="text-secondary font-label-md text-label-md uppercase tracking-wider font-semibold">Digital Orthodontics</span>
              <h2 className="font-headline-lg text-headline-lg text-primary tracking-tight mt-2 mb-4">
                Next-Generation Alignment Technology
              </h2>
              <p className="font-body-lg text-body-lg text-on-surface-variant">
                We utilize advanced 3D scanning and computer-aided treatment planning to ensure predictable, efficient, and comfortable tooth movement.
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div className="group p-6 rounded-2xl bg-surface hover:bg-surface-container-low transition-all duration-300 flex flex-col h-full shadow-sm hover:shadow-md">
                ...
                <h3 className="font-title-lg text-title-lg text-primary mb-2">3D Intraoral Scanners</h3>
                <p className="font-body-sm text-body-sm text-on-surface-variant leading-relaxed mb-4 flex-grow">
                  Eliminates messy traditional putty impressions, providing a highly accurate digital model of your teeth.
                </p>
              ...
              <div className="group p-6 rounded-2xl bg-surface hover:bg-surface-container-low transition-all duration-300 flex flex-col h-full shadow-sm hover:shadow-md">
                ...
                <h3 className="font-title-lg text-title-lg text-primary mb-2">Digital Treatment Simulation</h3>
                <p className="font-body-sm text-body-sm text-on-surface-variant leading-relaxed mb-4 flex-grow">
                  Advanced software maps out the exact movement of your teeth at every stage of the treatment.
                </p>
                <div className="pt-4 border-t border-outline-variant/30 flex items-center justify-between text-secondary font-label-sm text-label-sm font-semibold">
              ...
              <div className="group p-6 rounded-2xl bg-surface hover:bg-surface-container-low transition-all duration-300 flex flex-col h-full shadow-sm hover:shadow-md">
                ...
                <h3 className="font-title-lg text-title-lg text-primary mb-2">SmartTrack Materials</h3>
                <p className="font-body-sm text-body-sm text-on-surface-variant leading-relaxed mb-4 flex-grow">
              ...
              <div className="group p-6 rounded-2xl bg-surface hover:bg-surface-container-low transition-all duration-300 flex flex-col h-full shadow-sm hover:shadow-md">
                ...
                <h3 className="font-title-lg text-title-lg text-primary mb-2">Custom Attachments</h3>
                <p className="font-body-sm text-body-sm text-on-surface-variant leading-relaxed mb-4 flex-grow">
                  Tiny, tooth-colored grips are placed on specific teeth to facilitate complex movements with aligners.
                </p>
                <div className="pt-4 border-t border-outline-variant/30 flex items-center justify-between text-secondary font-label-sm text-label-sm font-semibold">
            ...
            <div className="mt-12 p-6 lg:p-8 rounded-2xl bg-gradient-to-r from-primary to-primary-container text-on-primary flex flex-col md:flex-row items-center justify-between gap-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h4 className="font-headline-sm text-headline-sm">Are Clear Aligners Right For You?</h4>
                  <p className="font-body-sm text-body-sm text-surface-variant mt-1">
                    Most cases can be treated with invisible aligners, offering a discreet and removable alternative to traditional metal braces.
                  </p>
                </div>
              </div>
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-12">
            <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-4">
              ...
              <p className="font-body-md text-body-md text-on-surface-variant max-w-md">
                Experience a seamless path to your new smile with our structured, digitally-guided process.
              </p>
            </div>
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 relative">
              ...
              <div className="p-6 rounded-2xl bg-surface-container-lowest shadow-sm flex flex-col relative">
                ...
                <h3 className="font-title-lg text-title-lg text-primary mb-2">Consultation &amp; 3D Scan</h3>
                <p className="font-body-sm text-body-sm text-on-surface-variant leading-relaxed">
                  Comprehensive evaluation of your bite and digital impression of your teeth.
                </p>
              </div>
              {/* Step 2 */}
              <div className="p-6 rounded-2xl bg-surface-container-lowest shadow-sm flex flex-col relative">
                ...
                <h3 className="font-title-lg text-title-lg text-primary mb-2">Treatment Planning</h3>
                <p className="font-body-sm text-body-sm text-on-surface-variant leading-relaxed">
                  Computer simulation of your tooth movements and timeline estimation.
                </p>
              </div>
              {/* Step 3 */}
              <div className="p-6 rounded-2xl bg-surface-container-lowest shadow-sm flex flex-col relative">
                ...
                <h3 className="font-title-lg text-title-lg text-primary mb-2">Appliance Delivery</h3>
                <p className="font-body-sm text-body-sm text-on-surface-variant leading-relaxed">
                  Fitting of your custom aligners or low-profile brackets.
                </p>
              </div>
              {/* Step 4 */}
              <div className="p-6 rounded-2xl bg-surface-container-lowest shadow-sm flex flex-col relative">
                ...
                <h3 className="font-title-lg text-title-lg text-primary mb-2">Progress Monitoring</h3>
                <p className="font-body-sm text-body-sm text-on-surface-variant leading-relaxed">
                  Regular check-ups to track your alignment and make necessary adjustments.
                </p>
              </div>
              {/* Step 5 */}
              <div className="p-6 rounded-2xl bg-surface-container-lowest shadow-sm flex flex-col relative">
                ...
                <h3 className="font-title-lg text-title-lg text-primary mb-2">Retention Phase</h3>
                <p className="font-body-sm text-body-sm text-on-surface-variant leading-relaxed">
                  Custom retainers provided to maintain your new smile forever.
                </p>
              </div>
            </div>
          </div>
              ...
              <div className="lg:col-span-5 order-2 lg:order-1">
                <div className="relative rounded-2xl overflow-hidden shadow-lg bg-surface-container">
                  ...
                  <div className="absolute bottom-4 left-4 right-4 p-4 rounded-xl bg-surface-container-lowest/90 backdrop-blur-md">
                    <p className="font-title-lg text-title-lg text-primary mb-0.5">Lifetime Smile Guarantee</p>
                    <p className="font-body-sm text-body-sm text-on-surface-variant">Our retention program ensures your teeth stay perfectly aligned.</p>
                  </div>
                </div>
              </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <select className="w-full px-4 py-3 rounded-lg bg-surface-container-lowest text-on-surface text-body-md focus:outline-none focus:ring-2 focus:ring-secondary">
                          <option>Braces &amp; Aligners &amp; Endodontics</option>
