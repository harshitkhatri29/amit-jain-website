        ...
        <section className="relative w-full bg-surface-container-lowest overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-12 pt-8 pb-16 lg:pb-24">
            ...
            <nav aria-label="Breadcrumb" className="flex items-center gap-2 mb-8 font-label-sm text-label-sm text-on-surface-variant">
              ...
              <span className="material-symbols-outlined text-[14px] text-outline">chevron_right</span>
              <span className="text-primary font-semibold">Teeth Whitening</span>
            </nav>
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
              ...
              <div className="lg:col-span-7 flex flex-col items-start">
                ...
                <h1 className="font-headline-lg text-headline-lg lg:font-display-xl lg:text-display-xl text-primary tracking-tight mb-6">
                  Single-Sitting Painless Teeth Whitening
                </h1>
                <p className="font-body-lg text-body-lg text-on-surface-variant mb-8 max-w-2xl leading-relaxed">
                  Gently lift deep tea, coffee, and tobacco stains for a brilliant, photogenic smile without triggering tooth sensitivity or enamel loss.
                </p>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 w-full mb-8">
                  <div className="p-3 rounded-xl bg-surface-container-low flex flex-col">
                    <span className="font-headline-sm text-headline-sm text-primary">60m</span>
                    <span className="font-label-sm text-label-sm text-on-surface-variant mt-0.5">Session Time</span>
                  </div>
                  <div className="p-3 rounded-xl bg-surface-container-low flex flex-col">
                    <span className="font-headline-sm text-headline-sm text-primary">up to 8</span>
                    <span className="font-label-sm text-label-sm text-on-surface-variant mt-0.5">Shades Whiter</span>
                  </div>
                  <div className="p-3 rounded-xl bg-surface-container-low flex flex-col">
                    <span className="font-headline-sm text-headline-sm text-primary">100%</span>
                    <span className="font-label-sm text-label-sm text-on-surface-variant mt-0.5">Enamel Safe</span>
                  </div>
                  <div className="p-3 rounded-xl bg-surface-container-low flex flex-col">
                    <span className="font-headline-sm text-headline-sm text-primary">5k+</span>
                    <span className="font-label-sm text-label-sm text-on-surface-variant mt-0.5">Smiles Brightened</span>
                  </div>
                </div>
                {/* CTAs */}
                ...
                <div className="flex flex-wrap items-center gap-2 pt-8">
                  <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-surface-container-low font-label-sm text-label-sm text-on-surface">
                    <span className="material-symbols-outlined text-secondary text-[16px]">verified</span> Laser Activation
                  </span>
                  <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-surface-container-low font-label-sm text-label-sm text-on-surface">
                    <span className="material-symbols-outlined text-secondary text-[16px]">verified</span> Desensitizing Gel
                  </span>
                  <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-surface-container-low font-label-sm text-label-sm text-on-surface">
                    <span className="material-symbols-outlined text-secondary text-[16px]">verified</span> Instant Results
                  </span>
                </div>
              </div>
              ...
              <div className="lg:col-span-5 relative">
                <div className="relative rounded-2xl overflow-hidden bg-surface-container shadow-xl">
                  <img className="w-full h-[460px] object-cover" data-alt="Close-up of a high-tech dental surgery operatory during an endodontic procedure. High-magnification clinical microscope hovering over a dental model with illuminated rotary titanium files and clear digital monitors displaying 3D dental root apex X-rays in clean teal, white, and soft steel-gray tones." src="https://lh3.googleusercontent.com/aida-public/AB6AXuCA-rUKWmHAWK_DXZAmULQ8ZbrYPDiX90KVTG6MPU4-Q01RMWJ6nEMeTWXFbkJZd9v23rXBbEgAz0zxj7ElDQeXP5W1mhr4p5KnYIRgPw-5Ett5wPettn7t1bDA035BM4W4crSTfzgTU8SxfyQHPB3jBUjpS6ayKI9oUuY5Y93t3c2JPEK8PSSuTg_uxAokuQzVOgvjQB20AlrLKmu2fkNXBDwaurwC0QAPd9MEpF4diEGNDM39tB5ouQ" />
                  <div className="absolute inset-0 bg-gradient-to-t from-primary/90 via-primary/30 to-transparent flex flex-col justify-end p-6 text-on-primary">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <div>
                        <span className="font-title-lg text-title-lg block">Advanced LED Acceleration</span>
                        <span className="font-label-sm text-label-sm text-secondary-fixed">Faster, Brighter Results</span>
                      </div>
                    </div>
                    <p className="font-body-sm text-body-sm text-surface-variant">
                      Our specialized light accelerates the whitening gel, breaking down stains faster.
                    </p>
                  </div>
                </div>
                ...
                <div className="hidden sm:flex absolute -bottom-6 -left-6 bg-surface-container-lowest p-4 rounded-xl shadow-lg items-center gap-3 z-10 max-w-xs">
                  ...
                  <div>
                    <p className="font-title-lg text-title-lg text-on-surface">Immediate Impact</p>
                    <p className="font-body-sm text-body-sm text-on-surface-variant">Walk out with a brighter smile today</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
              ...
              <div className="lg:col-span-5 flex flex-col">
                ...
                <p className="font-body-md text-body-md text-on-surface-variant mb-4 leading-relaxed">
                  Over time, the porous nature of tooth enamel absorbs pigments from food, drinks, and tobacco, leading to extrinsic stains. Aging also causes the underlying dentin to darken.
                </p>
                <p className="font-body-md text-body-md text-on-surface-variant mb-6 leading-relaxed">
                  Professional whitening utilizes active ingredients (like hydrogen or carbamide peroxide) that penetrate the enamel to break apart these complex stain molecules, restoring your tooth's natural brightness.
                </p>
                <div className="p-6 rounded-xl bg-surface-container-high flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-title-lg text-title-lg text-primary mb-1">Professional vs. Over-the-Counter</h4>
                    <p className="font-body-sm text-body-sm text-on-surface-variant">
                      In-office whitening provides controlled, high-concentration gels and protective barriers, ensuring far superior results and safety compared to drugstore kits.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="lg:col-span-7">
                <div className="mb-4">
                  ...
                  <h3 className="font-headline-sm text-headline-sm text-primary mt-1">Is Whitening Right For You?</h3>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="p-5 rounded-xl bg-surface-container-lowest shadow-sm hover:shadow-md transition-all flex flex-col justify-between">
                    ...
                    <div>
                      <h4 className="font-title-lg text-title-lg text-on-surface mb-1">Dietary Stains</h4>
                      <p className="font-body-sm text-body-sm text-on-surface-variant">
                        Discoloration from heavy consumption of coffee, tea, or red wine.
                      </p>
                    </div>
                  </div>
                  {/* Symptom 2 */}
                  <div className="p-5 rounded-xl bg-surface-container-lowest shadow-sm hover:shadow-md transition-all flex flex-col justify-between">
                    ...
                    <div>
                      <h4 className="font-title-lg text-title-lg text-on-surface mb-1">Tobacco Stains</h4>
                      <p className="font-body-sm text-body-sm text-on-surface-variant">
                        Yellow or brown staining caused by smoking or chewing tobacco.
                      </p>
                    </div>
                  </div>
                  {/* Symptom 3 */}
                  <div className="p-5 rounded-xl bg-surface-container-lowest shadow-sm hover:shadow-md transition-all flex flex-col justify-between">
                    ...
                    <div>
                      <h4 className="font-title-lg text-title-lg text-on-surface mb-1">Age-Related Yellowing</h4>
                      <p className="font-body-sm text-body-sm text-on-surface-variant">
                        Natural darkening of teeth as enamel thins and dentin changes with age.
                      </p>
                    </div>
                  </div>
                  {/* Symptom 4 */}
                  <div className="p-5 rounded-xl bg-surface-container-lowest shadow-sm hover:shadow-md transition-all flex flex-col justify-between">
                    ...
                    <div>
                      <h4 className="font-title-lg text-title-lg text-on-surface mb-1">Special Events</h4>
                      <p className="font-body-sm text-body-sm text-on-surface-variant">
                        Preparing for a wedding, graduation, or important life event.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="md:col-span-2 p-5 rounded-xl bg-surface-container-low shadow-sm flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="font-title-lg text-title-lg text-on-surface mb-1">Uneven Color</h4>
                      <p className="font-body-sm text-body-sm text-on-surface-variant">
                        General dullness or uneven shading across your smile.
                      </p>
                    </div>
                  </div>
                </div>
        ...
        <section className="w-full py-16 lg:py-24 bg-surface-container-lowest">
          <div className="max-w-7xl mx-auto px-6 lg:px-12">
            <div className="text-center max-w-3xl mx-auto mb-16">
              <span className="text-secondary font-label-md text-label-md uppercase tracking-wider font-semibold">Whitening Technology</span>
              ...
              <p className="font-body-lg text-body-lg text-on-surface-variant">
                We use industry-leading whitening technology designed to maximize results while minimizing sensitivity.
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div className="group p-6 rounded-2xl bg-surface hover:bg-surface-container-low transition-all duration-300 flex flex-col h-full shadow-sm hover:shadow-md">
                ...
                <h3 className="font-title-lg text-title-lg text-primary mb-2">LED Light Acceleration</h3>
                <p className="font-body-sm text-body-sm text-on-surface-variant leading-relaxed mb-4 flex-grow">
                  A specialized cool blue LED light activates the whitening gel, speeding up the stain-breaking process.
                </p>
              ...
              <div className="group p-6 rounded-2xl bg-surface hover:bg-surface-container-low transition-all duration-300 flex flex-col h-full shadow-sm hover:shadow-md">
                ...
                <h3 className="font-title-lg text-title-lg text-primary mb-2">Desensitizing Agents</h3>
                <p className="font-body-sm text-body-sm text-on-surface-variant leading-relaxed mb-4 flex-grow">
                  Our gels are formulated with potassium nitrate and fluoride to reduce post-treatment sensitivity.
                </p>
                <div className="pt-4 border-t border-outline-variant/30 flex items-center justify-between text-secondary font-label-sm text-label-sm font-semibold">
              ...
              <div className="group p-6 rounded-2xl bg-surface hover:bg-surface-container-low transition-all duration-300 flex flex-col h-full shadow-sm hover:shadow-md">
                ...
                <h3 className="font-title-lg text-title-lg text-primary mb-2">Custom Gum Protection</h3>
                <p className="font-body-sm text-body-sm text-on-surface-variant leading-relaxed mb-4 flex-grow">
                  Acoustic cavitation agitates disinfecting irrigants into microscopic lateral canals, eradicating 100% of biofilms and resistant E. faecalis microbes.
                </p>
                <div className="pt-4 border-t border-outline-variant/30 flex items-center justify-between text-secondary font-label-sm text-label-sm font-semibold">
              ...
              <div className="group p-6 rounded-2xl bg-surface hover:bg-surface-container-low transition-all duration-300 flex flex-col h-full shadow-sm hover:shadow-md">
                ...
                <h3 className="font-title-lg text-title-lg text-primary mb-2">Take-Home Maintenance</h3>
                <p className="font-body-sm text-body-sm text-on-surface-variant leading-relaxed mb-4 flex-grow">
                  Custom trays and professional-grade gel for at-home touch-ups to prolong your results.
                </p>
                <div className="pt-4 border-t border-outline-variant/30 flex items-center justify-between text-secondary font-label-sm text-label-sm font-semibold">
                  <span>Lasting Brightness</span>
                  <span className="material-symbols-outlined text-[16px]">arrow_forward</span>
                </div>
              </div>
            </div>
            ...
            <div className="mt-12 p-6 lg:p-8 rounded-2xl bg-gradient-to-r from-primary to-primary-container text-on-primary flex flex-col md:flex-row items-center justify-between gap-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h4 className="font-headline-sm text-headline-sm">Ready for a Brighter Smile?</h4>
                  <p className="font-body-sm text-body-sm text-surface-variant mt-1">
                    Transform your appearance and boost your confidence in just one hour.
                  </p>
                </div>
              </div>
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-12">
            <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-4">
              ...
              <p className="font-body-md text-body-md text-on-surface-variant max-w-md">
                A relaxing, straightforward procedure for immediate results.
              </p>
            </div>
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 relative">
              ...
              <div className="p-6 rounded-2xl bg-surface-container-lowest shadow-sm flex flex-col relative">
                ...
                <h3 className="font-title-lg text-title-lg text-primary mb-2">Shade Assessment</h3>
                <p className="font-body-sm text-body-sm text-on-surface-variant leading-relaxed">
                  Recording your current tooth shade to measure progress.
                </p>
              </div>
              {/* Step 2 */}
              <div className="p-6 rounded-2xl bg-surface-container-lowest shadow-sm flex flex-col relative">
                ...
                <h3 className="font-title-lg text-title-lg text-primary mb-2">Preparation &amp; Protection</h3>
                <p className="font-body-sm text-body-sm text-on-surface-variant leading-relaxed">
                  Applying protective barriers to your lips and gums.
                </p>
              </div>
              {/* Step 3 */}
              <div className="p-6 rounded-2xl bg-surface-container-lowest shadow-sm flex flex-col relative">
                ...
                <h3 className="font-title-lg text-title-lg text-primary mb-2">Gel Application</h3>
                <p className="font-body-sm text-body-sm text-on-surface-variant leading-relaxed">
                  Careful application of the professional whitening gel to your teeth.
                </p>
              </div>
              {/* Step 4 */}
              <div className="p-6 rounded-2xl bg-surface-container-lowest shadow-sm flex flex-col relative">
                ...
                <h3 className="font-title-lg text-title-lg text-primary mb-2">Light Activation</h3>
                <p className="font-body-sm text-body-sm text-on-surface-variant leading-relaxed">
                  The LED light is directed at your teeth for several 15-minute intervals.
                </p>
              </div>
              {/* Step 5 */}
              <div className="p-6 rounded-2xl bg-surface-container-lowest shadow-sm flex flex-col relative">
                ...
                <h3 className="font-title-lg text-title-lg text-primary mb-2">Reveal</h3>
                <p className="font-body-sm text-body-sm text-on-surface-variant leading-relaxed">
                  The gel is removed, and your new, brighter shade is revealed.
                </p>
              </div>
            </div>
          </div>
              ...
              <div className="lg:col-span-5 order-2 lg:order-1">
                <div className="relative rounded-2xl overflow-hidden shadow-lg bg-surface-container">
                  ...
                  <div className="absolute bottom-4 left-4 right-4 p-4 rounded-xl bg-surface-container-lowest/90 backdrop-blur-md">
                    <p className="font-title-lg text-title-lg text-primary mb-0.5">Dazzling Smile Guarantee</p>
                    <p className="font-body-sm text-body-sm text-on-surface-variant">Noticeably whiter teeth after just one appointment.</p>
                  </div>
                </div>
              </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <select className="w-full px-4 py-3 rounded-lg bg-surface-container-lowest text-on-surface text-body-md focus:outline-none focus:ring-2 focus:ring-secondary">
                          <option>Teeth Whitening &amp; Endodontics</option>
