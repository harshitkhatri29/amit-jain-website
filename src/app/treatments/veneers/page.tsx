        ...
        <section className="relative w-full bg-surface-container-lowest overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-12 pt-8 pb-16 lg:pb-24">
            ...
            <nav aria-label="Breadcrumb" className="flex items-center gap-2 mb-8 font-label-sm text-label-sm text-on-surface-variant">
              ...
              <span className="material-symbols-outlined text-[14px] text-outline">chevron_right</span>
              <span className="text-primary font-semibold">Veneers</span>
            </nav>
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
              ...
              <div className="lg:col-span-7 flex flex-col items-start">
                ...
                <h1 className="font-headline-lg text-headline-lg lg:font-display-xl lg:text-display-xl text-primary tracking-tight mb-6">
                  Single-Sitting Painless Veneers
                </h1>
                <p className="font-body-lg text-body-lg text-on-surface-variant mb-8 max-w-2xl leading-relaxed">
                  Remedy gaps, chips, uneven lengths, and severe discoloration with custom-crafted, ultra-thin ceramic veneers for a perfectly balanced smile.
                </p>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 w-full mb-8">
                  <div className="p-3 rounded-xl bg-surface-container-low flex flex-col">
                    <span className="font-headline-sm text-headline-sm text-primary">2-3</span>
                    <span className="font-label-sm text-label-sm text-on-surface-variant mt-0.5">Visits Required</span>
                  </div>
                  <div className="p-3 rounded-xl bg-surface-container-low flex flex-col">
                  ...
                  <div className="p-3 rounded-xl bg-surface-container-low flex flex-col">
                    ...
                    <span className="font-label-sm text-label-sm text-on-surface-variant mt-0.5">Stain Resistant</span>
                  </div>
                  <div className="p-3 rounded-xl bg-surface-container-low flex flex-col">
                    <span className="font-headline-sm text-headline-sm text-primary">2k+</span>
                    <span className="font-label-sm text-label-sm text-on-surface-variant mt-0.5">Veneers Placed</span>
                  </div>
                </div>
                {/* CTAs */}
                ...
                <div className="flex flex-wrap items-center gap-2 pt-8">
                  <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-surface-container-low font-label-sm text-label-sm text-on-surface">
                    <span className="material-symbols-outlined text-secondary text-[16px]">verified</span> Ultra-Thin Ceramic
                  </span>
                  <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-surface-container-low font-label-sm text-label-sm text-on-surface">
                    <span className="material-symbols-outlined text-secondary text-[16px]">verified</span> Digital Design
                  </span>
                  <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-surface-container-low font-label-sm text-label-sm text-on-surface">
                    <span className="material-symbols-outlined text-secondary text-[16px]">verified</span> Minimal Prep
                  </span>
                </div>
              </div>
              ...
              <div className="lg:col-span-5 relative">
                <div className="relative rounded-2xl overflow-hidden bg-surface-container shadow-xl">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-primary/90 via-primary/30 to-transparent flex flex-col justify-end p-6 text-on-primary">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <div>
                        <span className="font-title-lg text-title-lg block">Digital Smile Design</span>
                        <span className="font-label-sm text-label-sm text-secondary-fixed">Custom Aesthetics</span>
                      </div>
                    </div>
                    <p className="font-body-sm text-body-sm text-surface-variant">
                      Every veneer is meticulously designed using 3D software to match your facial proportions.
                    </p>
                  </div>
                </div>
                ...
                <div className="hidden sm:flex absolute -bottom-6 -left-6 bg-surface-container-lowest p-4 rounded-xl shadow-lg items-center gap-3 z-10 max-w-xs">
                  ...
                  <div>
                    <p className="font-title-lg text-title-lg text-on-surface">Flawless Finish</p>
                    <p className="font-body-sm text-body-sm text-on-surface-variant">Perfect symmetry and shade</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
              ...
              <div className="lg:col-span-5 flex flex-col">
                ...
                <p className="font-body-md text-body-md text-on-surface-variant mb-4 leading-relaxed">
                  Veneers are wafer-thin, custom-made shells of tooth-colored material designed to cover the front surface of teeth. They alter the color, shape, size, or length.
                </p>
                <p className="font-body-md text-body-md text-on-surface-variant mb-6 leading-relaxed">
                  Crafted from advanced dental porcelain or composite resin, they mimic the light-reflecting properties of natural teeth while offering superior resistance to stains.
                </p>
                <div className="p-6 rounded-xl bg-surface-container-high flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-title-lg text-title-lg text-primary mb-1">Conservative Transformation</h4>
                    <p className="font-body-sm text-body-sm text-on-surface-variant">
                      Unlike crowns, veneers require minimal removal of natural tooth structure, preserving the majority of your healthy enamel.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="lg:col-span-7">
                <div className="mb-4">
                  ...
                  <h3 className="font-headline-sm text-headline-sm text-primary mt-1">Are Veneers Right For You?</h3>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="p-5 rounded-xl bg-surface-container-lowest shadow-sm hover:shadow-md transition-all flex flex-col justify-between">
                    ...
                    <div>
                      <h4 className="font-title-lg text-title-lg text-on-surface mb-1">Discolored Teeth</h4>
                      <p className="font-body-sm text-body-sm text-on-surface-variant">
                        Stains from root canal treatment, tetracycline, or excess fluoride that resist whitening.
                      </p>
                    </div>
                  </div>
                  {/* Symptom 2 */}
                  <div className="p-5 rounded-xl bg-surface-container-lowest shadow-sm hover:shadow-md transition-all flex flex-col justify-between">
                    ...
                    <div>
                      <h4 className="font-title-lg text-title-lg text-on-surface mb-1">Worn Down Teeth</h4>
                      <p className="font-body-sm text-body-sm text-on-surface-variant">
                        Teeth that have been naturally worn down over time.
                      </p>
                    </div>
                  </div>
                  {/* Symptom 3 */}
                  <div className="p-5 rounded-xl bg-surface-container-lowest shadow-sm hover:shadow-md transition-all flex flex-col justify-between">
                    ...
                    <div>
                      <h4 className="font-title-lg text-title-lg text-on-surface mb-1">Chipped or Broken</h4>
                      <p className="font-body-sm text-body-sm text-on-surface-variant">
                        Teeth that have minor chips or structural damage.
                      </p>
                    </div>
                  </div>
                  {/* Symptom 4 */}
                  <div className="p-5 rounded-xl bg-surface-container-lowest shadow-sm hover:shadow-md transition-all flex flex-col justify-between">
                    ...
                    <div>
                      <h4 className="font-title-lg text-title-lg text-on-surface mb-1">Misaligned or Uneven</h4>
                      <p className="font-body-sm text-body-sm text-on-surface-variant">
                  ...
                  <div className="md:col-span-2 p-5 rounded-xl bg-surface-container-low shadow-sm flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="font-title-lg text-title-lg text-on-surface mb-1">Gaps Between Teeth</h4>
                      <p className="font-body-sm text-body-sm text-on-surface-variant">
                        Diastemas (gaps) that you wish to close without orthodontics.
                      </p>
                    </div>
                  </div>
                </div>
        ...
        <section className="w-full py-16 lg:py-24 bg-surface-container-lowest">
          <div className="max-w-7xl mx-auto px-6 lg:px-12">
            <div className="text-center max-w-3xl mx-auto mb-16">
              <span className="text-secondary font-label-md text-label-md uppercase tracking-wider font-semibold">Smile Design</span>
              ...
              <p className="font-body-lg text-body-lg text-on-surface-variant">
                We use a digital-first approach to plan your smile makeover, ensuring predictable and stunning results.
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div className="group p-6 rounded-2xl bg-surface hover:bg-surface-container-low transition-all duration-300 flex flex-col h-full shadow-sm hover:shadow-md">
                ...
                <h3 className="font-title-lg text-title-lg text-primary mb-2">3D Facial Scanning</h3>
                <p className="font-body-sm text-body-sm text-on-surface-variant leading-relaxed mb-4 flex-grow">
                  Captures the relationship between your teeth, lips, and facial features for harmony.
                </p>
              ...
              <div className="group p-6 rounded-2xl bg-surface hover:bg-surface-container-low transition-all duration-300 flex flex-col h-full shadow-sm hover:shadow-md">
                ...
                <h3 className="font-title-lg text-title-lg text-primary mb-2">Digital Mockups</h3>
                <p className="font-body-sm text-body-sm text-on-surface-variant leading-relaxed mb-4 flex-grow">
                  See a digital simulation of your proposed new smile before any treatment begins.
                </p>
                <div className="pt-4 border-t border-outline-variant/30 flex items-center justify-between text-secondary font-label-sm text-label-sm font-semibold">
              ...
              <div className="group p-6 rounded-2xl bg-surface hover:bg-surface-container-low transition-all duration-300 flex flex-col h-full shadow-sm hover:shadow-md">
                ...
                <h3 className="font-title-lg text-title-lg text-primary mb-2">E-Max Porcelain</h3>
                <p className="font-body-sm text-body-sm text-on-surface-variant leading-relaxed mb-4 flex-grow">
              ...
              <div className="group p-6 rounded-2xl bg-surface hover:bg-surface-container-low transition-all duration-300 flex flex-col h-full shadow-sm hover:shadow-md">
                ...
                <h3 className="font-title-lg text-title-lg text-primary mb-2">Trial Smile</h3>
                <p className="font-body-sm text-body-sm text-on-surface-variant leading-relaxed mb-4 flex-grow">
                  Temporary veneers allow you to 'test drive' your new smile's look and feel.
                </p>
                <div className="pt-4 border-t border-outline-variant/30 flex items-center justify-between text-secondary font-label-sm text-label-sm font-semibold">
            ...
            <div className="mt-12 p-6 lg:p-8 rounded-2xl bg-gradient-to-r from-primary to-primary-container text-on-primary flex flex-col md:flex-row items-center justify-between gap-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h4 className="font-headline-sm text-headline-sm">Ready for a Smile Makeover?</h4>
                  <p className="font-body-sm text-body-sm text-surface-variant mt-1">
                    Transform your entire appearance with a custom-designed set of porcelain veneers.
                  </p>
                </div>
              </div>
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-12">
            <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-4">
              ...
              <p className="font-body-md text-body-md text-on-surface-variant max-w-md">
                A collaborative journey to your perfect smile.
              </p>
            </div>
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 relative">
              ...
              <div className="p-6 rounded-2xl bg-surface-container-lowest shadow-sm flex flex-col relative">
                ...
                <h3 className="font-title-lg text-title-lg text-primary mb-2">Consultation &amp; Design</h3>
                <p className="font-body-sm text-body-sm text-on-surface-variant leading-relaxed">
                  Discussing your goals and taking digital scans to design your new smile.
                </p>
              </div>
              {/* Step 2 */}
              <div className="p-6 rounded-2xl bg-surface-container-lowest shadow-sm flex flex-col relative">
                ...
                <p className="font-body-sm text-body-sm text-on-surface-variant leading-relaxed">
                  Minimal reshaping of the enamel to accommodate the veneers.
                </p>
              </div>
              {/* Step 3 */}
              <div className="p-6 rounded-2xl bg-surface-container-lowest shadow-sm flex flex-col relative">
                ...
                <h3 className="font-title-lg text-title-lg text-primary mb-2">Temporary Placement</h3>
                <p className="font-body-sm text-body-sm text-on-surface-variant leading-relaxed">
                  Placing temporary veneers based on the approved design.
                </p>
              </div>
              {/* Step 4 */}
              <div className="p-6 rounded-2xl bg-surface-container-lowest shadow-sm flex flex-col relative">
                ...
                <h3 className="font-title-lg text-title-lg text-primary mb-2">Custom Fabrication</h3>
                <p className="font-body-sm text-body-sm text-on-surface-variant leading-relaxed">
                  Your permanent veneers are handcrafted by master ceramists.
                </p>
              </div>
              {/* Step 5 */}
              <div className="p-6 rounded-2xl bg-surface-container-lowest shadow-sm flex flex-col relative">
                ...
                <h3 className="font-title-lg text-title-lg text-primary mb-2">Final Bonding</h3>
                <p className="font-body-sm text-body-sm text-on-surface-variant leading-relaxed">
                  The final veneers are permanently bonded, adjusted, and polished.
                </p>
              </div>
            </div>
          </div>
              ...
              <div className="lg:col-span-5 order-2 lg:order-1">
                <div className="relative rounded-2xl overflow-hidden shadow-lg bg-surface-container">
                  ...
                  <div className="absolute bottom-4 left-4 right-4 p-4 rounded-xl bg-surface-container-lowest/90 backdrop-blur-md">
                    <p className="font-title-lg text-title-lg text-primary mb-0.5">Confidence Guarantee</p>
                    <p className="font-body-sm text-body-sm text-on-surface-variant">A smile you'll be proud to share with the world.</p>
                  </div>
                </div>
              </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <select className="w-full px-4 py-3 rounded-lg bg-surface-container-lowest text-on-surface text-body-md focus:outline-none focus:ring-2 focus:ring-secondary">
                          <option>Veneers &amp; Endodontics</option>
