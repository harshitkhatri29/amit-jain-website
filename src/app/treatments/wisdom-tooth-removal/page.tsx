        ...
        <section className="relative w-full bg-surface-container-lowest overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-12 pt-8 pb-16 lg:pb-24">
            ...
            <nav aria-label="Breadcrumb" className="flex items-center gap-2 mb-8 font-label-sm text-label-sm text-on-surface-variant">
              ...
              <span className="material-symbols-outlined text-[14px] text-outline">chevron_right</span>
              <span className="text-primary font-semibold">Wisdom Tooth Removal</span>
            </nav>
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
              ...
              <div className="lg:col-span-7 flex flex-col items-start">
                ...
                <h1 className="font-headline-lg text-headline-lg lg:font-display-xl lg:text-display-xl text-primary tracking-tight mb-6">
                  Single-Sitting Painless Wisdom Tooth Removal
                </h1>
                <p className="font-body-lg text-body-lg text-on-surface-variant mb-8 max-w-2xl leading-relaxed">
                  Safe and comfortable removal of impacted or painful wisdom molars with advanced piezoelectric bone surgery, minimizing trauma and healing time.
                </p>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 w-full mb-8">
                  <div className="p-3 rounded-xl bg-surface-container-low flex flex-col">
                    <span className="font-headline-sm text-headline-sm text-primary">30-45m</span>
                    <span className="font-label-sm text-label-sm text-on-surface-variant mt-0.5">Procedure Time</span>
                  </div>
                  <div className="p-3 rounded-xl bg-surface-container-low flex flex-col">
                    <span className="font-headline-sm text-headline-sm text-primary">0</span>
                    <span className="font-label-sm text-label-sm text-on-surface-variant mt-0.5">Pain Experienced</span>
                  </div>
                  <div className="p-3 rounded-xl bg-surface-container-low flex flex-col">
                    <span className="font-headline-sm text-headline-sm text-primary">Fast</span>
                    <span className="font-label-sm text-label-sm text-on-surface-variant mt-0.5">Recovery</span>
                  </div>
                  <div className="p-3 rounded-xl bg-surface-container-low flex flex-col">
                    <span className="font-headline-sm text-headline-sm text-primary">8k+</span>
                    <span className="font-label-sm text-label-sm text-on-surface-variant mt-0.5">Extractions</span>
                  </div>
                </div>
                {/* CTAs */}
                ...
                <div className="flex flex-wrap items-center gap-2 pt-8">
                  <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-surface-container-low font-label-sm text-label-sm text-on-surface">
                    <span className="material-symbols-outlined text-secondary text-[16px]">verified</span> Piezoelectric Surgery
                  </span>
                  <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-surface-container-low font-label-sm text-label-sm text-on-surface">
                    <span className="material-symbols-outlined text-secondary text-[16px]">verified</span> 3D CBCT Planning
                  </span>
                  <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-surface-container-low font-label-sm text-label-sm text-on-surface">
                    <span className="material-symbols-outlined text-secondary text-[16px]">verified</span> Conscious Sedation
                  </span>
                </div>
              </div>
              ...
              <div className="lg:col-span-5 relative">
                <div className="relative rounded-2xl overflow-hidden bg-surface-container shadow-xl">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-primary/90 via-primary/30 to-transparent flex flex-col justify-end p-6 text-on-primary">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <div>
                        <span className="font-title-lg text-title-lg block">Advanced 3D Imaging</span>
                        <span className="font-label-sm text-label-sm text-secondary-fixed">Safe Surgical Planning</span>
                      </div>
                    </div>
                    <p className="font-body-sm text-body-sm text-surface-variant">
                      3D CBCT scans precisely locate nerves to ensure completely safe removal.
                    </p>
                  </div>
                </div>
                ...
                <div className="hidden sm:flex absolute -bottom-6 -left-6 bg-surface-container-lowest p-4 rounded-xl shadow-lg items-center gap-3 z-10 max-w-xs">
                  ...
                  <div>
                    <p className="font-title-lg text-title-lg text-on-surface">Quick Recovery</p>
                    <p className="font-body-sm text-body-sm text-on-surface-variant">Advanced techniques minimize swelling</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
              ...
              <div className="lg:col-span-5 flex flex-col">
                ...
                <p className="font-body-md text-body-md text-on-surface-variant mb-4 leading-relaxed">
                  Wisdom teeth, or third molars, often lack sufficient space to erupt properly. This causes them to become 'impacted', growing at incorrect angles and pushing against adjacent teeth.
                </p>
                <p className="font-body-md text-body-md text-on-surface-variant mb-6 leading-relaxed">
                  Impacted wisdom teeth can lead to pericoronitis (gum infection), decay of the adjacent tooth, cyst formation, and severe jaw pain. Proactive removal is often the safest path.
                </p>
                <div className="p-6 rounded-xl bg-surface-container-high flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-title-lg text-title-lg text-primary mb-1">Precision over Force</h4>
                    <p className="font-body-sm text-body-sm text-on-surface-variant">
                      Modern oral surgery relies on detailed 3D imaging and specialized instruments to remove the tooth atraumatically, preserving surrounding bone.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="lg:col-span-7">
                <div className="mb-4">
                  ...
                  <h3 className="font-headline-sm text-headline-sm text-primary mt-1">Signs Your Wisdom Teeth Need Removal</h3>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="p-5 rounded-xl bg-surface-container-lowest shadow-sm hover:shadow-md transition-all flex flex-col justify-between">
                    ...
                    <div>
                      <h4 className="font-title-lg text-title-lg text-on-surface mb-1">Jaw Pain</h4>
                      <p className="font-body-sm text-body-sm text-on-surface-variant">
                        Throbbing pain or stiffness in the back of the jaw.
                      </p>
                    </div>
                  </div>
                  {/* Symptom 2 */}
                  <div className="p-5 rounded-xl bg-surface-container-lowest shadow-sm hover:shadow-md transition-all flex flex-col justify-between">
                    ...
                    <div>
                      ...
                      <p className="font-body-sm text-body-sm text-on-surface-variant">
                        Red, tender, or bleeding gums around the back of your mouth.
                      </p>
                    </div>
                  </div>
                  {/* Symptom 3 */}
                  <div className="p-5 rounded-xl bg-surface-container-lowest shadow-sm hover:shadow-md transition-all flex flex-col justify-between">
                    ...
                    <div>
                      <h4 className="font-title-lg text-title-lg text-on-surface mb-1">Limited Opening</h4>
                      <p className="font-body-sm text-body-sm text-on-surface-variant">
                        Difficulty or pain when trying to open your mouth fully (trismus).
                      </p>
                    </div>
                  </div>
                  {/* Symptom 4 */}
                  <div className="p-5 rounded-xl bg-surface-container-lowest shadow-sm hover:shadow-md transition-all flex flex-col justify-between">
                    ...
                    <div>
                      ...
                      <p className="font-body-sm text-body-sm text-on-surface-variant">
                        Persistent bad breath or a bad taste from infection under the gum flap.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="md:col-span-2 p-5 rounded-xl bg-surface-container-low shadow-sm flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="font-body-sm text-body-sm text-on-surface-variant">
                        Feeling pressure as the wisdom tooth pushes your other teeth forward.
                      </p>
                    </div>
                  </div>
                </div>
        ...
        <section className="w-full py-16 lg:py-24 bg-surface-container-lowest">
          <div className="max-w-7xl mx-auto px-6 lg:px-12">
            <div className="text-center max-w-3xl mx-auto mb-16">
              <span className="text-secondary font-label-md text-label-md uppercase tracking-wider font-semibold">Surgical Technology</span>
              ...
              <p className="font-body-lg text-body-lg text-on-surface-variant">
                We utilize the latest surgical technology to ensure a swift, safe, and comfortable extraction experience.
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div className="group p-6 rounded-2xl bg-surface hover:bg-surface-container-low transition-all duration-300 flex flex-col h-full shadow-sm hover:shadow-md">
                ...
                <h3 className="font-title-lg text-title-lg text-primary mb-2">3D CBCT Scanning</h3>
                <p className="font-body-sm text-body-sm text-on-surface-variant leading-relaxed mb-4 flex-grow">
                  Provides a 3D view of the tooth roots and their proximity to the inferior alveolar nerve.
                </p>
              ...
              <div className="group p-6 rounded-2xl bg-surface hover:bg-surface-container-low transition-all duration-300 flex flex-col h-full shadow-sm hover:shadow-md">
                ...
                <h3 className="font-title-lg text-title-lg text-primary mb-2">Piezoelectric Surgery</h3>
                <p className="font-body-sm text-body-sm text-on-surface-variant leading-relaxed mb-4 flex-grow">
                  Uses ultrasonic micro-vibrations to cut bone selectively without damaging soft tissues or nerves.
                </p>
                <div className="pt-4 border-t border-outline-variant/30 flex items-center justify-between text-secondary font-label-sm text-label-sm font-semibold">
                  <span>Less Trauma</span>
                  <span className="material-symbols-outlined text-[16px]">arrow_forward</span>
                </div>
              </div>
              {/* Tech Card 3 */}
              <div className="group p-6 rounded-2xl bg-surface hover:bg-surface-container-low transition-all duration-300 flex flex-col h-full shadow-sm hover:shadow-md">
                ...
                <h3 className="font-title-lg text-title-lg text-primary mb-2">Advanced Anesthesia</h3>
                <p className="font-body-sm text-body-sm text-on-surface-variant leading-relaxed mb-4 flex-grow">
                  Acoustic cavitation agitates disinfecting irrigants into microscopic lateral canals, eradicating Fast of biofilms and resistant E. faecalis microbes.
                </p>
                <div className="pt-4 border-t border-outline-variant/30 flex items-center justify-between text-secondary font-label-sm text-label-sm font-semibold">
                  <span>Painless</span>
                  <span className="material-symbols-outlined text-[16px]">arrow_forward</span>
              ...
              <div className="group p-6 rounded-2xl bg-surface hover:bg-surface-container-low transition-all duration-300 flex flex-col h-full shadow-sm hover:shadow-md">
                ...
                <h3 className="font-title-lg text-title-lg text-primary mb-2">PRF Therapy</h3>
                <p className="font-body-sm text-body-sm text-on-surface-variant leading-relaxed mb-4 flex-grow">
                  Platelet-Rich Fibrin, created from your own blood, is placed in the socket to accelerate healing.
                </p>
                <div className="pt-4 border-t border-outline-variant/30 flex items-center justify-between text-secondary font-label-sm text-label-sm font-semibold">
            ...
            <div className="mt-12 p-6 lg:p-8 rounded-2xl bg-gradient-to-r from-primary to-primary-container text-on-primary flex flex-col md:flex-row items-center justify-between gap-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h4 className="font-headline-sm text-headline-sm">Experiencing Wisdom Tooth Pain?</h4>
                  <p className="font-body-sm text-body-sm text-surface-variant mt-1">
                    Don't wait for an infection. Get a precise 3D evaluation and painless removal.
                  </p>
                </div>
              </div>
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-12">
            <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-4">
              ...
              <p className="font-body-md text-body-md text-on-surface-variant max-w-md">
                A structured approach to safe and comfortable surgery.
              </p>
            </div>
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 relative">
              ...
              <div className="p-6 rounded-2xl bg-surface-container-lowest shadow-sm flex flex-col relative">
                ...
                <h3 className="font-title-lg text-title-lg text-primary mb-2">3D Diagnostic Scan</h3>
                <p className="font-body-sm text-body-sm text-on-surface-variant leading-relaxed">
                  CBCT scan to evaluate the exact position of the tooth and nerves.
                </p>
              </div>
              {/* Step 2 */}
              <div className="p-6 rounded-2xl bg-surface-container-lowest shadow-sm flex flex-col relative">
                ...
                <h3 className="font-title-lg text-title-lg text-primary mb-2">Profound Numbing</h3>
                <p className="font-body-sm text-body-sm text-on-surface-variant leading-relaxed">
                  Ensuring you are completely numb and comfortable before proceeding.
                </p>
              </div>
              {/* Step 3 */}
              <div className="p-6 rounded-2xl bg-surface-container-lowest shadow-sm flex flex-col relative">
                ...
                <h3 className="font-title-lg text-title-lg text-primary mb-2">Atraumatic Access</h3>
                <p className="font-body-sm text-body-sm text-on-surface-variant leading-relaxed">
                  Gentle removal of any bone or tissue covering the tooth.
                </p>
              </div>
              {/* Step 4 */}
              <div className="p-6 rounded-2xl bg-surface-container-lowest shadow-sm flex flex-col relative">
                ...
                <h3 className="font-title-lg text-title-lg text-primary mb-2">Sectioning &amp; Removal</h3>
                <p className="font-body-sm text-body-sm text-on-surface-variant leading-relaxed">
                  The tooth is often divided into smaller pieces for easier, less invasive removal.
                </p>
              </div>
              {/* Step 5 */}
              <div className="p-6 rounded-2xl bg-surface-container-lowest shadow-sm flex flex-col relative">
                ...
                <h3 className="font-title-lg text-title-lg text-primary mb-2">Suturing &amp; PRF</h3>
                <p className="font-body-sm text-body-sm text-on-surface-variant leading-relaxed">
                  The site is cleaned, PRF is placed, and dissolvable stitches are applied.
                </p>
              </div>
            </div>
          </div>
              ...
              <div className="lg:col-span-5 order-2 lg:order-1">
                <div className="relative rounded-2xl overflow-hidden shadow-lg bg-surface-container">
                  ...
                  <div className="absolute bottom-4 left-4 right-4 p-4 rounded-xl bg-surface-container-lowest/90 backdrop-blur-md">
                    <p className="font-title-lg text-title-lg text-primary mb-0.5">Smooth Recovery Guarantee</p>
                    <p className="font-body-sm text-body-sm text-on-surface-variant">Detailed post-op instructions and medications to ensure a fast, comfortable healing phase.</p>
                  </div>
                </div>
              </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <select className="w-full px-4 py-3 rounded-lg bg-surface-container-lowest text-on-surface text-body-md focus:outline-none focus:ring-2 focus:ring-secondary">
                          <option>Wisdom Tooth Removal &amp; Endodontics</option>
